...
ingest_refs:
  ...
  - ingest/links/2026-06-04-drv-bundeszuschuss-glossar.md
...
Die gesetzliche Rentenversicherung soll zu einer allgemeinen, umlagefinanzierten
Erwerbstätigenversicherung weiterentwickelt werden. Neue Rentenpunkte entstehen
ab Reformstichtag nur noch, wenn dafür echte Beiträge gezahlt werden. Wenn der
Staat Kindererziehung, Pflege, Arbeitslosigkeit, Dienstzeiten oder andere
gesellschaftliche Ziele rentenwirksam fördern will, muss der zuständige
...
- Die Demographieannahmen werden aus `analysen/` übernommen, damit Rente und
...
| --- | ---: |
| Beitragssatz allgemeine Rentenversicherung 2026 | 18,6 % |
| Beitragssatz knappschaftliche Rentenversicherung 2026 | 24,7 % |
| Beitragsbemessungsgrenze allgemeine RV 2026 | 8.450 Euro monatlich / 101.400 Euro jährlich |
| Beitragsbemessungsgrenze knappschaftliche RV 2026 | 10.400 Euro monatlich / 124.800 Euro jährlich |
| Vorläufiges Durchschnittsentgelt 2026 | 51.944 Euro jährlich |
| Aktueller Rentenwert bis 30.06.2026 | 40,79 Euro |
...
- Rechenergebnis: `analysen/2026-06-04-rente-belastungsrechnung.md`
...
`analysen/2026-06-04-rente-belastungsrechnung.md` abgelegt:
...
Die Deutsche Rentenversicherung weist für 2025 folgende Rechnungsergebnisse aus
(alle Beträge in Mrd. Euro, Rundungsdifferenzen möglich):

### Einnahmen

| Einnahmeart | Betrag | Anteil an Gesamteinnahmen |
| --- | ---: | ---: |
| Beitragseinnahmen gesamt | 321,552 | 76,1 % |
| Allgemeiner Bundeszuschuss / Defizitausgleich KnRV | 65,754 | 15,6 % |
| Zusätzlicher Bundeszuschuss | 32,104 | 7,6 % |
| Erstattungen von Versorgungsdienststellen | 1,381 | 0,3 % |
| Vermögenserträge | 1,511 | 0,4 % |
| Sonstige Einnahmen | 0,302 | 0,1 % |
| Einnahmen gesamt | 422,605 | 100,0 % |

### Ausgaben

| Ausgabeart | Betrag | Anteil an Gesamtausgaben |
| --- | ---: | ---: |
| Rentenausgaben | 379,420 | 89,0 % |
| Zuschüsse zur Krankenversicherung der Rentner | 32,199 | 7,5 % |
| Leistungen zur Teilhabe | 8,709 | 2,0 % |
| Verwaltungs- und Verfahrenskosten | 5,646 | 1,3 % |
| Beitragserstattungen, KLG und sonstige Ausgaben | 0,547 | 0,1 % |
| Ausgaben gesamt | 426,521 | 100,0 % |

Der Saldo 2025 lag damit bei rund -3,917 Mrd. Euro. Beitragseinnahmen deckten
...
Die allgemeine Rentenversicherung meldete für Januar bis März 2026 kumulierte
Beitragseinnahmen von 78,841 Mrd. Euro. Im selben Zeitraum betrugen die
Renten-Zahlbeträge des Postrentenbestandes zusammen rund 84,131 Mrd. Euro.
Die Nachhaltigkeitsrücklage der allgemeinen Rentenversicherung sank von
41,303 Mrd. Euro im Dezember des Vorjahres auf 37,327 Mrd. Euro Ende März
2026; das entsprach 1,19 Monatsausgaben.

## Relevante Gesetze und Bestimmungen

| Bereich | Normen | Relevanz für Reform |
| --- | --- | --- |
| Versichertenkreis Beschäftigte | SGB VI § 1 | Ausgangspunkt für Pflichtversicherung abhängig Beschäftigter. |
| Selbständige | SGB VI § 2, § 165, § 169, § 190a | Heute nur bestimmte Selbständige pflichtversichert; Reform erweitert Pflicht auf alle Erwerbstätigen. |
| Sonstige Versicherte | SGB VI § 3, § 166, § 170, § 177 | Kindererziehung, Pflege, Dienstzeiten und weitere Sozialzeiten müssen beitragsklar finanziert werden. |
| Versicherungsfreiheit und Befreiung | SGB VI §§ 5, 6, 8, 230 ff. | Beamte, berufsständische Versorgung und Altfälle benötigen Bestandsschutz und Neuzugangsregeln. |
...
Das heutige System vermischt drei Finanzierungslogiken:

- Beitragsrente aus Erwerbsbeiträgen.
- Sozialpolitisch gewünschte Rentenwirkungen, etwa Kindererziehung, Pflege,
...
Jeder rentenwirksame Monat erhält eine Finanzierungsquelle:

- Arbeitnehmer- und Arbeitgeberbeiträge.
- Beiträge von Selbständigen.
- Beiträge öffentlicher Träger für staatlich gewünschte Rentenwirkung.
- Nachversicherung oder Übergangsbeiträge für neu einbezogene Gruppen.
...
`analysen/daten/2026-06-04-drv-rentenbestand-struktur.csv`. Sie
...
- Kindererziehung: Bund zahlt Beiträge nach gesetzlicher Bemessungsgrundlage.
- Pflege: Pflegeversicherung oder Bund zahlt Beiträge für nicht erwerbsmäßige
  Pflegepersonen.
- Arbeitslosigkeit und Qualifizierung: Bundesagentur für Arbeit oder Bund zahlt
  Beiträge aus definierter Bemessungsgrundlage.
- Dienst- und Einsatzzeiten: zuständiger Dienstherr zahlt Beiträge.
...
- Neu verbeamtete Personen werden ab Reformstichtag 1.1.2030 rentenversicherungspflichtig
  ...
  auf jeden Ruhestand 0,75 Nachbesetzungen folgen, die ebenfalls einzahlen.
...
- Berufsständische Versorgungswerke und bestehende Beamtenversorgung werden
  nicht rückwirkend enteignet, aber für Neuzugänge neu geordnet.

### 4. Umlage mit Demografie-Puffer
...
- SGB VI §§ 5, 6, 8, 230 ff.: Versicherungsfreiheit und Befreiung für
  Neuzugänge neu fassen; Bestandsschutz explizit regeln.
- SGB VI §§ 54-58: Beitragsfreie und beitragsgeminderte Zeiten bereinigen oder
  mit Zahlungspflicht öffentlicher Träger verknüpfen.
- SGB VI §§ 66, 70, 71, 76g, 113, 114: Entgeltpunkte ab Reformstichtag nur bei
  Beitragszahlung oder gesetzlich geschuldeter staatlicher Beitragszahlung.
- SGB VI §§ 157-170: Beitragsbemessung für Selbständige und neue
...
- Öffentlicher Dienst: für jeden Ruhestand werden im Arbeitsmodell 0,75 Stellen
...
- Exakte Abgrenzung nicht beitragsgedeckter Leistungen nach einheitlicher

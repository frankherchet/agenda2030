...
- Datenbasis: `analysen/daten/2026-06-04-drv-rentenbestand-struktur.csv`
- Auswertung: `analysen/2026-06-04-bundeszuschuss-abschmelzung.md`
...
| --- | --- | --- | --- |
| Sterblichkeit aus Destatis 2022/2024 | Destatis Periodensterbetafel | Original-XLSX liegt unter `ingest/originale/`; Tabellen `12613-b01` und `12613-b02` enthalten `lx`, `px` und Alter. | ok |
...
- Datenquelle: `analysen/daten/2026-06-04-drv-rentenbestand-struktur.csv`
...
- Datenquelle: `analysen/daten/2026-06-04-bundesmittel-zerlegung.csv`
...
- Datenquelle: `analysen/daten/2026-06-04-bundeszuschuss-abschmelzung.csv`

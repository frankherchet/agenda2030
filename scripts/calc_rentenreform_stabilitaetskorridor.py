...
def write_assumptions() -> None:
    rows = [
        ...
        ("beitragsbasis", "Status quo plus Erwerbstaetigenbasis", "scripts/calc_rentenreform_zukunft.py", "Selbststaendige und Neubeamte beziehungsweise neue Dienstherrenbeiträge werden ab 2030 schrittweise einbezogen; im öffentlichen Dienst gilt die 0,75-Nachbesetzungsquote aus dem Zukunftsmodell."),
